...
private:
    ...
    const int ADDITIONAL_MEMBER_SIZE= sizeof(mp_data_size) + sizeof (m_frame_number);
...
public:
    ...
    CommonFrame(const unsigned int t_frame_number, const char *p_data, const int t_data_size) {
        ...
        this->mp_data_size =  ADDITIONAL_MEMBER_SIZE + t_data_size;
        ...
        memcpy(this->mp_data + ADDITIONAL_MEMBER_SIZE, p_data, t_data_size);
